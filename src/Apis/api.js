...
const BASE_URL = process.env.NODE_ENV === 'production' ? 'https://api.asknfty.com/nft/v1' : '/nft/v1'
// const BASE_URL = BASE_HOST + 'nft/v1/nft-collections?queries=collection_name__OR__description:nam'
